...
CREATE TABLE IF NOT EXISTS users (
  ...
  hs_focus TEXT NOT NULL DEFAULT '[]',
...
CREATE TABLE IF NOT EXISTS buyers (
  ...
  first_shipment_date TEXT,
  last_shipment_date TEXT,
  total_shipments INTEGER DEFAULT 0,
  total_volume_kg REAL DEFAULT 0,
  total_value_usd REAL DEFAULT 0,
  shipments_12mo INTEGER DEFAULT 0,
  volume_12mo_kg REAL DEFAULT 0,
  value_12mo_usd REAL DEFAULT 0,
  yoy_percent REAL,
  has_indonesian_supplier INTEGER DEFAULT 0,
  activity_score INTEGER,
  growth_score INTEGER,
  reachability_score INTEGER,
  untapped_score INTEGER,
  base_score INTEGER
);

CREATE TABLE IF NOT EXISTS buyer_hs (
...
CREATE TABLE IF NOT EXISTS exporters (
  ...
  name TEXT NOT NULL,
  country TEXT NOT NULL,
  is_indonesian INTEGER DEFAULT 0
);
...
CREATE TABLE IF NOT EXISTS shipments (
  ...
  weight_kg REAL, quantity REAL, quantity_unit TEXT,
  value_usd REAL, container_count INTEGER,
  goods_description TEXT,
  source TEXT DEFAULT 'US CBP AMS'
);
...
CREATE TABLE IF NOT EXISTS messages (
  ...
  opened_at TEXT, replied_at TEXT
);
...
CREATE TABLE IF NOT EXISTS profile_views (
  ...
  PRIMARY KEY (user_id, buyer_id, period)
);
